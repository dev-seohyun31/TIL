...
> 입력의 경우, 핀에 아무것도 연결되어있지 않으면 떠 있기 떄문에 전압이 안정적으로 고정되지 않아 노이즈에 의해 불안정하게 흔들립니다. 
전압이 흔들리고 있기 때문에 pin을 통해 값을 받을 땐 핀에 저항을 두어 고정으로 0을을 만들거나(pull-down), 1로 만들(pull-up) 수 있습니다.

> 출력의 경우, 레지스터에서 0과 1의 값을 갖고 전압을 만듭니다. 전압을 만드는 과정에서 전압을 HIGH과 LOW를 적극적으로 만드는 push-pull 옵션과 LOW만 적극적으로 만들어주는 open-drain 옵션이 있습니다.
